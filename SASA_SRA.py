# -*- coding: utf-8 -*-
"""
Created on Mon Mar 23 19:22:20 2015
...
import numpy as np
from scipy.spatial.distance import cdist  # Cdist computes the distance between each pair of the two collections of inputs
...
def assign_params(atom_types):
    ...
    TODO Document me!
    """
    SRA_model = {'hydroxyl_carboxyl H': (2.85, -0.0487), 'amine_amide H': (2.85, -0.0487), 'thiol H': (2.85, 0.0690), 'aliphatic CH3': (0.946, 0.0676), 'aliphatic CH2': (0.946, 0.0193), 'aliphatic CH': (0.946, 0.00438), 'aliphatic_alicyclic C': (0.946, 0.01691), 'alicyclic CH2': (0.946, 0.0190), 'alicyclic CH': (0.946, 0.0190), 'aromatic CH': (0.946, -0.0110), 'aromatic C': (0.946, -0.137), 'aromatic C of fused ring': (0.946, -0.103), 'aromatic CH of fused ring': (0.946, 0.2342), 'carbonyl_carboxylic C': (0.946, -0.104), 'N primary amine': (4.10, -0.0225), 'N secondary amine': (4.10, -0.0213), 'N cyclic amine': (4.10, -0.0254), 'aromatic N': (4.10, -0.0234), 'N amide': (4.10, -0.0337), 'ether_hydroxyl O': (2.83, -0.0282), 'carboxylic O': (2.83, 0.0394), 'carbonyl O': (2.83, -0.0489), 'amide carbonyl O': (2.83, -0.0920), 'thiol or sulfide S': (7.37, -0.0020)} 
    params = {}
