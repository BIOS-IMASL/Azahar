...
def get_omega(obj, bond, state=0): 
    """
...
def set_phi(obj, bond, angle, state=0):
    """
...
def set_psi(obj, bond, angle, state=0): 
    """
...
def set_omega(obj, bond, angle, state=0): 
    """
    Get the dihedral angle omega (O6-C6-C5-C4)
    """
    resi_i, resi_j, atom_i, atom_j = bond[0], bond[2], bond[4], bond[5]
